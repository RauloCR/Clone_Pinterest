        ...
        if (/image\/*/.test(event.target.files[0].type)) {
            ...
            reader.onload = function() {
                ...
                new_image.onload = function () {
                    ...
                    new_image.classList.add('pin_max_widht');
                    ...
                    if (
                        new_image.getBoundingClientRect().widht < new_image.parentElement.getBoundingClientRect().width ||
                        new_image.getBoundingClientRect().height < new_image.parentElement.getBoundingClientRect().height
                    ){
                        new_image.classList.remove('pin_max_widht');
