    ...
    <div class="modal_foot">
        <div class="destination">
            <div class="pint_mock_icon_container">
                <img src="./img/Arrow_up_right.PNG" alt="destination" class="pint_mock_icon">
            </div>
            <span>${pin_details.destination}</span>
        </div>

        <div class="pint_mock_icon_container">
            <img src="./img/Send.png" alt="send" class="pint_mock_icon">
        </div>

        <div class="pint_mock_icon_container">
            <img src="./img/Ellipse.png" alt="edit" class="pint_mock_icon">
        </div>
    </div>
</div>  
